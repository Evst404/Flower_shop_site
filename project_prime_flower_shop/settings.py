...
SECRET_KEY = 'your-secret-key-here'  # потом сгенерировать ключ
DEBUG = True
ALLOWED_HOSTS = []
...
EMAIL_HOST = 'smtp.mail.ru'  # Заменить на свой SMTP (например, Gmail)
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your@email.ru'  # email
